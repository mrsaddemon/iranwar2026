export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T10:01:45.539Z",
  "warDay": 176,
  "summary": "Tensions in West Asia have escalated with new US sanctions on Iran and Hezbollah, US-Israel strikes on Iran, and reciprocal threats regarding military targets and the Strait of Hormuz.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 7,
    "summary": "No active ceasefire is in effect; conflict is escalating."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    ...
    {
      "date": "Aug 20",
      "text": "Iran declares US sanctions a 'declaration of war' on all nations and warns of 'devastating' response.",
      "severity": "critical",
    ...
    {
      "date": "Aug 20",
      "text": "Trump states he views the Strait of Hormuz as 'American territory' and threatens Iran's trade partners.",
      "severity": "warning",
    ...
    {
      "date": "Aug 20",
      "text": "Iran eyes US military bases in Europe as potential targets if war escalates.",
      "severity": "critical",
