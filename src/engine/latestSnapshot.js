export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T11:08:00.302Z",
  "warDay": 176,
  "summary": "Tensions remain high in the Middle East with ongoing US-Iran conflict, rising US casualties, and threats of economic and military escalation, while Israel and Turkey issue warnings over Syria and the Strait of Hormuz remains a flashpoint.",
  ...
  "recentEvents": [
    {
      "date": "Aug 21",
      "text": "US gas prices are up nearly a dollar from a year ago, attributed to low traffic in the Strait of Hormuz.",
      "severity": "info",
    ...
    {
      "date": "Aug 21",
      "text": "Iran and Oman discuss the situation in the Strait of Hormuz.",
      "severity": "info",
    ...
    {
      "date": "Aug 21",
      "text": "Israel and Turkey increase warnings over Syria following an airbase bombing.",
      "severity": "warning",
    ...
    {
      "date": "Aug 21",
      "text": "Former PM Bennett suggests Israel should strike Iran in retaliation for Hezbollah attacks.",
      "severity": "critical",
