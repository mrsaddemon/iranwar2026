export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T15:30:15.610Z",
  "warDay": 176,
  "summary": "Tensions remain high in the Middle East with ongoing economic pressure and military posturing between the US and Iran, while Israel and Hezbollah continue to clash.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 7,
    "summary": "No active ceasefire or de-escalation efforts are reported amidst ongoing regional tensions."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    {
      "date": "Aug 21",
      "text": "US gas prices are up nearly a dollar from a year ago, with Strait of Hormuz traffic remaining low.",
      "severity": "warning",
    ...
    {
      "date": "Aug 21",
      "text": "Israel and Turkey have stepped up warnings over Syria following an airbase bombing.",
      "severity": "warning",
