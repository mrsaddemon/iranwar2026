export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-07-04T07:54:49.944Z",
  "warDay": 127,
  "summary": "Active conflict continues with US, Israeli, and Iranian forces exchanging strikes, while diplomatic talks between the US and Iran show positive progress amidst heightened tensions over the Strait of Hormuz.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 5,
    "summary": "No active ceasefire is in effect, despite ongoing diplomatic discussions between the US and Iran."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    {
      ...
      "sourceName": "CNN",
      "latestSinceUpdate": 1160
    },
    {
      "date": "Jul 02",
      "text": "US and Iran hold separate meetings in Qatar, agreeing to continue discussions with 'positive progress'.",
      "severity": "info",
    ...
    {
      "date": "Jul 02",
      "text": "Israel bombs Lebanon following the end of Khamenei's funeral.",
      "severity": "critical",
      "sourceUrl": null,
    ...
    {
      "date": "Jul 02",
      "text": "US hits Iran after a threat to respond to Gulf fire.",
      "severity": "critical",
