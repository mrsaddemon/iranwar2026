export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-23T23:04:01.114Z",
  "warDay": 177,
  ...
  "ceasefire": {
    ...
    "confidence": 0.69,
    "durationDays": 25,
    "summary": "A fragile ceasefire in Lebanon is reportedly being exploited by Hezbollah for arms smuggling, amidst broader regional conflict."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    ...
    {
      "date": "Aug 22",
      "text": "Iran’s hardline new security chief issues stark threat to Gulf states ahead of fresh US sanctions.",
      "severity": "critical",
