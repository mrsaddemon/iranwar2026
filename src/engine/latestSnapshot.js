export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T05:56:59.729Z",
  "warDay": 176,
  "summary": "The conflict in West Asia has escalated with US-Israel strikes on Iran, new US sanctions, and increased tensions around the Strait of Hormuz, while US casualties continue to rise.",
  ...
  "recentEvents": [
    {
      ...
      "sourceName": "CNN",
      "latestSinceUpdate": 2119
    },
    {
      "date": "Aug 20",
      "text": "US-Israel strikes hit Iran, and the US Embassy in Riyadh was attacked as West Asia conflict escalates.",
      "severity": "critical",
    ...
    {
      "date": "Aug 20",
      "text": "Pentagon reports over 750 US service members have been wounded in the Iran war.",
      "severity": "warning",
    ...
    {
      "date": "Aug 20",
      "text": "Israel and Turkey step up warnings over Syria following an airbase bombing.",
      "severity": "warning",
    ...
    {
      "date": "Aug 20",
      "text": "Concerns are raised about increased risks of collisions and oil spills in the Strait of Hormuz due to the ongoing conflict.",
      "severity": "warning",
      "sourceUrl": null,
