export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-05-17T14:00:15.752Z",
  "warDay": 79,
  ...
  "ceasefire": {
    ...
    "confidence": 0.93,
    "durationDays": 45,
    "summary": "A ceasefire in Lebanon has been extended but is being violated by continued Israeli strikes in the south."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    {
      ...
      "latestSinceUpdate": 681
    },
    {
      "date": "May 17",
      "text": "Drone hits UAE power plant",
      "severity": "critical",
      "sourceUrl": null,
    ...
    {
      "date": "May 17",
      "text": "Iran says it will unveil Hormuz toll mechanism soon",
      "severity": "warning",
    ...
    {
      "date": "May 17",
      "text": "US, Israel preparing for resumptions of strikes against Iran",
      "severity": "warning",
    ...
    {
      "date": "May 17",
      "text": "Pentagon quietly shut legally required program to prevent civilian deaths by military",
      "severity": "info",
