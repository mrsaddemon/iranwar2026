export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-20T18:14:36.327Z",
  "warDay": 174,
  "summary": "The region is experiencing heightened economic pressure on Iran from the US, ongoing military actions by Israel in Gaza and Lebanon, and efforts to secure oil transit through the Strait of Hormuz amidst escalating rhetoric.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 7,
    "summary": "No active ceasefire or de-escalation efforts are reported amidst ongoing military actions and economic pressures."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    ...
    {
      "date": "Aug 19",
      "text": "Trump announces 'crushing economic operation' on Iran, threatening trade partners.",
      "severity": "critical",
    ...
    {
      "date": "Aug 19",
      "text": "U.S. Navy is helping get oil through the Strait of Hormuz, with a stealth operation reported.",
      "severity": "info",
