export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-25T19:39:23.633Z",
  "warDay": 179,
  "summary": "The US has announced new sanctions against Iran, which has vowed retaliation, while an oil tanker was attacked in the Strait of Hormuz and Israel conducted strikes in Syria amidst ongoing tensions with Hezbollah.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 15,
    "summary": "No active ceasefire or de-escalation efforts are reported amidst ongoing conflict and sanctions."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    ...
    {
      "date": "Aug 25",
      "text": "Oil tanker attacked in Strait of Hormuz as Iran claims plan to shoulder Trump sanctions.",
      "severity": "critical",
