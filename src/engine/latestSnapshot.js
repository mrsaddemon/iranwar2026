export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T20:52:09.921Z",
  "warDay": 176,
  "summary": "The Iran-US conflict continues with escalating economic pressure from the US, strong rhetoric from Iran, and increasing US military casualties, while regional tensions persist in Gaza and Lebanon.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.08,
    "durationDays": 7,
    "summary": "No active ceasefire is reported in the Iran-US conflict or related regional tensions."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
