export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "recentEvents": [
    {
      "date": "Apr 14",
      "text": "Iran war live: Three ships pass through Hormuz strait amid US, Iran blocks",
      "severity": "info",
    ...
    {
      "date": "Apr 14",
      "text": "Live updates: US eyes potential second round of talks with Iran as blockade takes hold",
      "severity": "critical",
    ...
    {
      "date": "Apr 14",
      "text": "Iran demands compensation from Gulf states after accusing them of role in US-Israeli strikes",
      "severity": "info",
