export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-22T12:54:27.037Z",
  "warDay": 176,
  "summary": "The ongoing conflict involving Iran, the US, and Israel continues with reports of US casualties, Iranian threats against US assets in Europe, and continued tensions over the Strait of Hormuz.",
  ...
  "recentEvents": [
    {
      "date": "Aug 21",
      "text": "US gas prices are up nearly a dollar from a year ago, attributed to low traffic through the Strait of Hormuz.",
      "severity": "warning",
    ...
    {
      "date": "Aug 21",
      "text": "Iran and Oman discuss the situation in the Strait of Hormuz, with Tehran dismissing threats from former US President Trump.",
      "severity": "info",
    ...
    {
      "date": "Aug 21",
      "text": "Israel and Turkey increase warnings regarding Syria following an airbase bombing.",
      "severity": "warning",
    ...
    {
      "date": "Aug 21",
      "text": "Former Israeli Prime Minister Bennett suggests Israel should strike Iran in retaliation for Hezbollah attacks.",
      "severity": "critical",
