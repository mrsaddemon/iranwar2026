export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-05-23T16:30:00.000Z",
  "warDay": 85,
  ...
  "ceasefire": {
    ...
    "confidence": 0.93,
    "durationDays": 14,
    "summary": "Intense mediation efforts are underway between the US and Iran, but no formal ceasefire is active, with ongoing military actions and threats."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    {
      ...
      "latestSinceUpdate": 749
    },
    {
      "date": "May 23",
      "text": "Pakistan reports 'progress' made in US-Iran mediation bid.",
      "severity": "info",
    ...
    {
      "date": "May 23",
      "text": "US preparing for possible strikes against Iran, according to sources.",
      "severity": "warning",
      "sourceUrl": null,
    ...
    {
      "date": "May 23",
      "text": "100 ships redirected amid naval blockade of Iran ports and the Strait of Hormuz, Centcom reports.",
      "severity": "critical",
      "sourceUrl": "https://news.google.?hl=en-US&gl=US&ceid=US:en",
      "sourceName": "The Hill",
      "latestSinceUpdate": 749
    },
    {
