export const LATEST_SNAPSHOT = Object.freeze({
  ...
  "lastSyncedAt": "2026-08-24T14:04:49.166Z",
  "warDay": 178,
  "summary": "Tensions between the US and Iran are escalating significantly, with the US preparing new economic sanctions and Iran threatening a harsh response, including potential disruption of Gulf oil exports and military action, while Israel conducts strikes in Syria and Hezbollah exploits a fragile ceasefire in Lebanon.",
  ...
  "ceasefire": {
    ...
    "confidence": 0.69,
    "durationDays": 30,
    "summary": "A ceasefire is active in Lebanon but is described as fragile due to Hezbollah exploiting it for arms smuggling and stalling disarmament efforts."
  },
  "actorOverrides": {
    "usa": {
      "metrics": {
  ...
  "recentEvents": [
    ...
    {
      "date": "Aug 23",
      "text": "Iran warns of a harsh response to anticipated US sanctions and threatens Gulf oil exports.",
      "severity": "critical",
    ...
    {
      "date": "Aug 23",
      "text": "Trump claims Strait of Hormuz as 'American territory,' prompting Iranian response to shut it.",
      "severity": "critical",
      "sourceUrl": "https://news.google.com/articles/CBMirAFBVV95cUxQNTVUMFgxVlR3aDd4Zl9mekxKSmwxOTlxRWtsWl9neHZnaElZTkFtYjF4QVVZbk8ycFM4NWJRYzlQUmNzQldQb3FHLVNydjJvM08xcml1cTJ5bi1HSGVtOTZQVnZXLVZvQmF4WFZ6amRJUzdJTVB6QVhXNldxVG95bmpTUU1VR29JdnJJMU5qQ0tqYnJ1M1ZaWXFHaXc0LXpuX0paMk1ENmltTUd5?hl=en-US&gl=US&ceid=US:en",
      "sourceName": "CNN",
      "latestSinceUpdate": 2223
    },
    {
