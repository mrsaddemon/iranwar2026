...
export const MAP_LABELS = [
  { text: 'GREECE', coordinates: [22.8, 38.8], color: 'rgba(147, 197, 253, 0.44)' },
  { text: 'CYPRUS', coordinates: [33.0, 35.1], color: 'rgba(147, 197, 253, 0.46)' },
  ...
  { text: 'PALESTINE', coordinates: [35.2, 31.2], color: 'rgba(59, 130, 246, 0.68)' },
  ...
  { text: 'LIBYA', coordinates: [18.8, 27.8], color: 'rgba(148, 163, 184, 0.36)' },
  { text: 'SUDAN', coordinates: [30.2, 16.0], color: 'rgba(148, 163, 184, 0.36)' },
  { text: 'ERITREA', coordinates: [39.5, 15.4], color: 'rgba(148, 163, 184, 0.36)' },
  { text: 'DJIBOUTI', coordinates: [42.7, 11.8], color: 'rgba(148, 163, 184, 0.4)' },
  ...
  { text: 'KUWAIT', coordinates: [47.8, 29.4], color: 'rgba(249, 115, 22, 0.58)' },
  { text: 'QATAR', coordinates: [51.1, 25.4], color: 'rgba(239, 68, 68, 0.62)' },
  { text: 'BAHRAIN', coordinates: [50.55, 26.08], color: 'rgba(239, 68, 68, 0.62)' },
  { text: 'UAE', coordinates: [54.7, 24.2], color: 'rgba(249, 115, 22, 0.62)' },
  { text: 'OMAN', coordinates: [57.2, 21.2], color: 'rgba(148, 163, 184, 0.48)' },
  { text: 'GEORGIA', coordinates: [43.6, 42.1], color: 'rgba(148, 163, 184, 0.4)' },
  { text: 'ARMENIA', coordinates: [44.9, 40.3], color: 'rgba(148, 163, 184, 0.42)' },
  { text: 'AZERBAIJAN', coordinates: [47.6, 40.5], color: 'rgba(148, 163, 184, 0.42)' },
  { text: 'TURKMENISTAN', coordinates: [58.4, 39.4], color: 'rgba(148, 163, 184, 0.38)' },
  { text: 'PAKISTAN', coordinates: [67.0, 29.2], color: 'rgba(125, 211, 252, 0.66)' },
  { text: 'INDIA', coordinates: [79.8, 21.3], color: 'rgba(253, 224, 71, 0.4)' },
