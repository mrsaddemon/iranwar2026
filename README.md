...
A live, source-informed dashboard for exploring escalation, military pressure, economic disruption, and nuclear risk in the 2026 Iran war scenario.
...
The app is built to feel immediate and readable for public users without requiring technical knowledge of the underlying model.
...
- React + Vite
- Custom HTML5 Canvas map renderer
